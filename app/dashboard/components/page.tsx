...
export default function Page() {
  return (
    <PageLayout breadcrumbs={[{ label: "Component Templates" }]} title="Component Family Templates">
      <p className="text-xl text-slate-600 mb-8 leading-relaxed">
        Pre-approved cross-semantic token patterns for common component families, with documented rationale and usage
        guidelines.
      </p>

      <section id="button-family" className="mt-12">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Button Family</h2>
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-xl font-semibold mb-4">Button Medium</h3>
            <div className="space-y-3">
              <TokenExample
                token="padding-block: space-300"
                value="Medium"
                type="semantic"
                description="Vertical padding matches semantic classification"
              />
              <TokenExample
                token="gap: space-100"
                value="Small"
                type="cross-semantic"
                description="Cross-semantic authorized for content density"
              />
              <TokenExample
                token="margin-block: space-50"
                value="Small"
                type="cross-semantic"
                description="Cross-semantic authorized for compact stacking"
              />
            </div>
          </div>

          <div>
            <h3 className="text-xl font-semibold mb-4">Button Large</h3>
            <div className="space-y-3">
              <TokenExample
                token="padding-inline: space-200"
                value="Medium"
                type="cross-semantic"
                description="Cross-semantic authorized for accessibility (touch targets)"
              />
              <TokenExample
                token="padding-block: space-100"
                value="Small"
                type="semantic"
                description="Maintains compact vertical footprint"
              />
            </div>
          </div>

          <Callout type="info" title="Rationale">
            Button accessibility requires larger horizontal spacing than Small semantic size provides, while maintaining
      ...
      <section id="badge-family" className="mt-16">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Badge & Chip Family</h2>
          <div className="flex gap-2">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-xl font-semibold mb-4">All Badge & Chip Variants</h3>
            <div className="space-y-3">
              <TokenExample
          ...
          <Callout type="info" title="Rationale">
            Text within badges requires sufficient horizontal breathing room for readability, especially at small font
            sizes.
          </Callout>
        </div>
      </section>
      ...
      <section id="form-family" className="mt-16">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Form Elements Family</h2>
          <div className="flex gap-2">
            <Badge variant="outline">Small to Medium</Badge>
        ...
        <div className="space-y-6">
          ...
          <Callout type="info" title="Rationale">
            Form usability requires adequate space for content entry and label association, often exceeding Small
      ...
      <section id="modal-family" className="mt-16">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Modal Family</h2>
          <div className="flex gap-2">
        ...
        <div className="space-y-6">
          ...
          <Callout type="info" title="Rationale">
            Modal contexts require enhanced spatial relationships for content hierarchy and user focus, often requiring
            tokens larger than component semantic size.
          </Callout>
        </div>
      </section>
      ...
      <section id="nav-family" className="mt-16">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Navigation Family</h2>
          <div className="flex gap-2">
            <Badge variant="outline">Small</Badge>
        ...
        <div className="space-y-6">
          ...
          <Callout type="info" title="Rationale">
            Navigation requires larger interaction areas for usability, while maintaining compact vertical profile for
            layout efficiency.
          </Callout>
        </div>
      </section>
      ...
      <section id="alert-family" className="mt-16">
        <div className="flex items-center gap-4 mb-6">
          <h2 className="text-3xl font-semibold tracking-tight">Alert & Notification Family</h2>
          <div className="flex gap-2">
        ...
        <div className="space-y-6">
          ...
          <Callout type="success" title="Rationale">
            Alert components use semantic Medium tokens for proper prominence and readability in notification contexts.
          </Callout>
        </div>
      </section>
    </PageLayout>
